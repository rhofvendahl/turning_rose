...
def perform_blender_operations(
    ...
    # This wasn't in the script for decimation but was in the remove outer script;
    # seems unlikely to mess things up though.
...
if __name__ == "__main__":
    names = get_names()
    process_models(names[:-1], 256)
    process_models(names[-1:], 1024)
